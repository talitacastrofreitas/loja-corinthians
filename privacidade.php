...
<main class="flex-fill">
  <div class="container">
    ...
    <hr>
                <p>A sua privacidade é importante para nós. É política do SCCP Online respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=http://www.dominio.com>SCCP Online</a>, e outros sites que possuímos e operamos.</p>
                ...
                <h2>Política de Cookies SCCP Online</h2>
                ...
                <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o SCCP Online oferece no site e com caráter enunciativo, mas não limitativo:</p>
                <ul>
                    ...
                    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do SCCP Online, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
                </ul>
