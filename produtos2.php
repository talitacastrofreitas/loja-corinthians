    ...
    <div class="container">
        <div class="row g-3">
            <div class="col-12 col-sm-6">
                <img src="./img/produtos/Jaqueta-roxa.webp" class="img-thumbnail" id="imgProduto" alt="Imagem Principal">
                <br class="clearfix">

                <div class="row my-3 gx-3">
                    <div class="col-3">
                        <img src="./img/produtos/Jaqueta-roxa.webp" class="img-thumbnail imagemMiniatura" alt="Imagem 2" onclick="trocarImagem(this)">
                    </div>

                    <div class="col-3">
                        <img src="./img/produtos/jaqueta-roxo.webp" class="img-thumbnail imagemMiniatura" alt="Imagem 3" onclick="trocarImagem(this)">
                    </div>

                    <div class="col-3">
                        <img src="./img/produtos/Jaqueta-branca.webp" class="img-thumbnail imagemMiniatura" alt="Imagem 4" onclick="trocarImagem(this)">
                    </div>

                    <div class="col-3">
                        <img src="./img/produtos/jaqueta.webp" class="img-thumbnail imagemMiniatura" alt="Imagem 5" onclick="trocarImagem(this)">
                    </div>
            ...
            <div class="col-12 col-sm-6">
                <h3>Jaquetas Sport Clube Corinthians Paulista</h3>
                ...
                <p>
                    <button class="btn btn-lg btn-danger mb-3 mb-xl-0 me-2"> <i class="bi-cart"></i> Adicionar ao carrinho</button>
